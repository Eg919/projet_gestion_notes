class Matiere:
    ...
    def to_dict(self):
        ...
        return {
            ...
            "coefficient_cot": self.coefficient_cot,
    ...
    def from_dict(data: dict):
        ...
        return Matiere(
            ...
            coefficient_cot=data.get("coefficient_cot", 0.0),
